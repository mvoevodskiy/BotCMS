        ...
        this.addBtnRow = async (buttons) => {
            ...
            for (let button of buttons) {
                ...
                if (typeof button === 'string') {
                    const text = this.translatable ? await this.BC.lexicon(button, {}, this._language, this.ctx) : button
                    ...
                    if (this.translatable) {
                        const text = await this.BC.lexicon(button.text, button.params || {}, this._language, this.ctx)
