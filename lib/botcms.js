...
class BotCMS {
    ...
    constructor (config = {}) {
        ...
        this.defaults = {
            ...
            serviceEvents: [EVENTS.MESSAGE_NEW, EVENTS.MESSAGE_EDIT, EVENTS.CHAT_MESSAGE_NEW, EVENTS.CHAT_MESSAGE_EDIT,
                EVENTS.QUERY_CALLBACK, EVENTS.QUERY_INLINE]
        };
    ...
    async doUpdate (current, ctx, opts = {}) {
        ...
        if (!this.MT.empty(current.message) && this.config.messageEvents.indexOf(ctx.Message.event) !== -1) {
